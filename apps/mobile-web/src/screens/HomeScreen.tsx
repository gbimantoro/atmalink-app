...
export function HomeScreen() {
  ...
  return (
    <div className="pb-24">
      {/* Hero Header with Orange Curve */}
      <div className="relative">
        <div className="absolute inset-0 bg-primary" style={{ clipPath: "ellipse(100% 80% at 50% 0%)" }} />
        <div className="relative px-6 py-10 pb-20">
          ...
          {/* Search Bar */}
          <Link to="/news" className="block bg-white/20 backdrop-blur-sm rounded-full px-5 py-3 flex items-center gap-3 text-white">
            ...
            <span className="text-white/70">Cari berita, event, alumni...</span>
          </Link>
        </div>
      </div>
